...
| **김태성** | **Python 라인트레이싱 & WebSocket 서버**<br>- R Pi + PiCam → OpenCV 기반 트랙 검출 알고리즘 개발<br>- 카메라에 잡히지 않는 트랙 예측 알고리즘 구현<br>- PID 제어 루프 설계 및 실시간 영상 스트리밍 구현 |
...
UART통신을 사용해서 시리얼 데이터를 주고 받을 수 있도록 함.
